...
final class StageController extends AbstractController
{
    ...
    #[Route('/stage/new', name: 'app_stage_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/stage/{id}/edit', name: 'app_stage_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/stage/{id}', name: 'app_stage_delete', methods: ['POST'])]
